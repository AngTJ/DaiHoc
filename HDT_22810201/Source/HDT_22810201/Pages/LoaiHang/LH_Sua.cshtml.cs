...
{
	public class LH_SuaModel : PageModel
	{
		...
		[BindProperty] public HDT_22810201_Entities.LoaiHang LoaiHang { get; set; }
		public LH_SuaModel(IXuLyLoaiHang xuLyLoaiHang)
		{
		...
		public void OnPost()
		{
			...
			{
				ServiceResult kq = _xuLyLoaiHang.Sua(Loai!, LoaiHang.Loai);
				if (kq.IsSuccess) Response.Redirect("/loai-hang/danh-sach/?trang=" + Trang);
				else
				{
					BaoLoi = kq.Message;
					LoaiHang = _xuLyLoaiHang.LayLoaiHang(Loai!);
				}
			}
		}
	}
